    ...
    <form action='{{route("products.update", ["product" => $products->id])}}' method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="AlertQuantity" name="AlertQuantity" value='{{$products->AlertQuantity}}' required>
            </div>
            <div class="col-md-4">
                <label for="StockQuantity" class="form-label">Quatidade em Estoque</label>
                <input type="text" class="form-control" id="StockQuantity" name="StockQuantity" value='{{$products->StockQuantity}}' required>
            </div>
            <div class="col-md-4">
